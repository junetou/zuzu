					 ...
					 <div class="flexslider">
							  <ul class="slides">  
							    <c:if test="${onepic != 'null' }">
							  	<li data-thumb="<woo:url value='/static/commoditypicture/${onepic }'/>">
									 <div class="thumb-image"> <img src="<woo:url value='/static/commoditypicture/${onepic }'/>" data-imagezoom="true" style="height:200px;" class="img-responsive" alt=""/> </div>
								</li>
							    </c:if>
							    <c:if test="${twopic != 'null' }">
								<li data-thumb="<woo:url value='/static/commoditypicture/${twopic }'/>">
									 <div class="thumb-image"> <img src="<woo:url value='/static/commoditypicture/${twopic }'/>" data-imagezoom="true" style="height:200px;" class="img-responsive" alt=""/> </div>
								</li>
								</c:if>
								<c:if test="${threepic != 'null' }">
								<li data-thumb="<woo:url value='/static/commoditypicture/${threepic }'/>">
								   <div class="thumb-image"> <img src="<woo:url value='/static/commoditypicture/${threepic }'/>" data-imagezoom="true" style="height:200px;" class="img-responsive" alt=""/> </div>
								</li> 
								</c:if>
								<c:if test="${onepic == 'null' }">
								  <c:if test="${twopic == 'null' }">
...
<div class="modal fade" id="mymodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	    	<form action="/commodity/lineman" id="reset-form" method="post">
