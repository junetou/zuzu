...
<div class="container" style="text-align:center;">
	 ...
	 <div class="col-md-8 contact-top-right">
					<div>
						<label>
						    <p>联系人</p>
							<input type="text" value="${contact }" style="min-width:200px;" readonly="true" tabindex="1">
						</label>
					</div>
					<div>
						<label>
						    <p>联系人电话</p>
							<input type="text" value="${contactphone }" style="min-width:200px;" readonly="true" tabindex="2">
						</label>
					</div>
					<div>
						<label>
...
<div class="modal fade" id="mymodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	    	<form id="reset-form" method="post" action="/purchase/addFed">
