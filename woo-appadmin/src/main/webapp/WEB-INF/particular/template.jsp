...
<link href="<woo:url value='/static/css/form.css'/>" rel="stylesheet" type="text/css" media="all" />
<link href="<woo:url value='/static/css/memenu.css'/>" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" href="<woo:url value='/static/css/flexslider.css'/>" type="text/css" media="screen" />
...
<script src="<woo:url value='/static/js/jquery-1.11.1.min.js'/>"></script>
<script src="<woo:url value='/static/js/modernizr.custom.js'/>"></script>
<script src="<woo:url value='/static/js/simpleCart.min.js'/>"> </script>
