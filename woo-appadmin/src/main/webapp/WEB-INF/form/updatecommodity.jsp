     ...
     <div class="contact-top">
         <div class="container">
		  <div class="col-md-8 contact-top-right">
            <form:form id="defaultForm" method="post" class="form-horizontal" action="/commodity/update/update/${command.id}"  enctype="multipart/form-data" >
	            ...
	            <form:textarea class="form-control"  style="max-width:600px; max-height:200px;"  id="infoamtion" name="infomation" path="infomation"/>
	            </div>
				<ul  class="container" >
						...
						<img src="<woo:url value="/static/commoditypicture/${command.picone}"/>" id="img1"  class="img-rounded " >
						</c:if>
						<c:if test="${command.picone=='null' }">
						...
						<img src="<woo:url value="/static/commoditypicture/${command.pictwo}"/>" id="img2"  class="img-rounded " >
						</c:if>
						<c:if test="${command.pictwo =='null' }">
						...
						<img src="<woo:url value="/static/commoditypicture/${command.picthree}"/>" id="img3"  class="img-rounded " >
						</c:if>
						<c:if test="${command.picthree=='null' }">
...
<div class="modal fade" id="mymodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	    	<form action="/commodity/update/delete" id="reset-form" method="post" onsubmit="return check()">
...
function uploadFile(){  
	if (window.File && window.FileList) {
	      ...
	      xhr.open("POST", "<c:url value='/commodity/update/update/${command.id}'/>",true);
	      xhr.send(fd);
	    }
}  
</script>