...
<div id="panel panel-default" class="panel panel-default">
   <div class="panel-heading">
     <ol class="breadcrumb">
     <li>求租信息</li>
     <li>求租名字：${thingsname }</li>
       ...
       <div class="form-gourp">
          ...
          <label>图片</label>
             <ul id="auto-loop" class="gallery" >
              <c:if test="${picname != '' }">
              <li data-src="<woo:url value="/static/needspicture/${picname }"/>" > 
        	  <a href="#">
              <img src="<woo:url value="/static/needspicture/${picname }"/>" alt="" id="lis"  class="img-rounded" />
              </a>
              </li>
              </c:if>
              <c:if test="${onepicture != '' }">
              <li data-src="<woo:url value="/static/needspicture/${onepicture }"/>"   > 
        	  <a href="#">
              <img src="<woo:url value="/static/needspicture/${onepicture }"/>" alt="" id="lis"   class="img-rounded" />
              </a>
              </li>
              </c:if>
              <c:if test="${twopicture != '' }">
              <li data-src="<woo:url value="/static/needspicture/${twopicture }"/>" >  
        	  <a href="#">
              <img src="<woo:url value="/static/needspicture/${twopicture }"/>" alt="" id="lis"  class="img-rounded" />
              </a> 
              </li>
              </c:if>
    </ul>
...
$(document).ready(function(){
	...
	oImg.style.top=document.getElementById("panel-default").offsetHeight+'px';
});
(function ($) {
