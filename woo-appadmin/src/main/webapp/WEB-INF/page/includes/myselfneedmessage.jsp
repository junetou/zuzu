   ...
   <woo:permission operationType="THINGS_VIEW" roleType="ROLE_THINGS">
        ...
        <div class="form-gourp">
          <label>图片</label>
              ...
              <li data-src="<woo:url value="/static/needspicture/${thingsonepicture }"/>" > 
        	  <a href="#">
              <img src="<woo:url value="/static/needspicture/${thingsonepicture }"/>" alt="" id="lis"  class="img-rounded" />
              </a>
              </li>
              </c:if>
              <c:if test="${thingstwopicture != '' }">
              <li data-src="<woo:url value="/static/needspicture/${thingstwopicture }"/>"   > 
        	  <a href="#">
              <img src="<woo:url value="/static/needspicture/${thingstwopicture }"/>" alt="" id="lis"   class="img-rounded" />
              </a>
              </li>
              </c:if>
              <c:if test="${thingsthreepicture != '' }">
              <li data-src="<woo:url value="/static/needspicture/${thingsthreepicture }"/>" >  
        	  <a href="#">
              <img src="<woo:url value="/static/needspicture/${thingsthreepicture }"/>" alt="" id="lis"  class="img-rounded" />
              </a> 
              </li>
              </c:if>
    </ul>
