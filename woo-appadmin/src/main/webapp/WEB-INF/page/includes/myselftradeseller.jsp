...
<p style="font-family: Helvetica,Hiragino Sans GB,Microsoft Yahei,微软雅黑, Arial, sans-serif">其他用户需求的并且你有此物品租借</p>
...
<tr>
	...
	<c:forEach items="${grid.datas}" var="data" varStatus="index" >
		<tr height="80px;">
		<th>${data.borrowname }</th>
		<th>${data.goodsname }</th>
		<th>
		<woo:permission operationType="TRADE_DELETE" roleType="ROLE_TRADE">
									<a href="javascript:void(0);" data-id="${data.trade }"  class="btnEdit" data-url="trade/cancelseller">
									[取消借出]
									</a>
		                        </woo:permission>
		</th>
