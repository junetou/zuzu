...
<div id="wrapper"  >
    ...
    <ul class="gallery" >
              ...
              <li data-src="<woo:url value="/static/needspicture/${data.onepicture }"/>" > 
        	  <a href="#">
              <img src="<woo:url value="/static/needspicture/${data.onepicture }"/>" alt="" id="lis" width="50px;" height="50px;" class="img-rounded" />
              </a>
              </li>
              </c:if>
              <c:if test="${data.twopicture != '' }">
              <li data-src="<woo:url value="/static/needspicture/${data.twopicture }"/>"   > 
        	  <a href="#">
              <img src="<woo:url value="/static/needspicture/${data.twopicture }"/>" alt="" id="lis" width="50px;" height="50px;"  class="img-rounded" />
              </a>
              </li>
              </c:if>
              <c:if test="${data.threepicture != '' }">
              <li data-src="<woo:url value="/static/needspicture/${data.threepicture }"/>" >  
        	  <a href="#">
              <img src="<woo:url value="/static/needspicture/${data.threepicture }"/>" alt="" id="lis" width="50px;" height="50px;" class="img-rounded" />
              </a> 
              </li>
              </c:if>
    </ul>
    ...
    <button type="button" class="btn btn-default" ><a href="<c:url value='/portal/needs/detailmessage/${data.thingsId}'/>">查看详细信息</a></button>
    </div>
    </li>
    </ul>
    </c:forEach>
	...
	<div style="height:10px;">
     <p></p>
        ...
        <div class="navbar "  style=" margin:0px auto;border:0;padding:0;">
