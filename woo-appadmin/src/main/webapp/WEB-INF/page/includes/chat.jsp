...
<div class="content" id="content" style="display: none"    >  
    ...
    <div class="leftcontact" id="leftcontact"    >
		...
		<div id="contractlist11" style="height:470px;" >
...
<div class="chatRight" > 
	    <div id="chat01">
	     ...
	     <div class="chat02_bar">
             <ul>
               <li style="right: 5px; top: 5px;"><img src="<woo:url value='/static/img/send_btn.jpg'/>" onClick="sendText()" /></li>
             </ul>
         </div>
...
<div id="confirm-block-div-modal"  class="three"  style="display:none;"
   ...
   <div class="modal-footer">
   <button id="confirm-block-footer-cancelButton" class="btn" data-dismiss="modal" style="display:none;" >关闭
   </button>
   </div>
</div>
