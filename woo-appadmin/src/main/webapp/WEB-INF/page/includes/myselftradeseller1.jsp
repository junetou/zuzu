...
<p style="font-family: Helvetica,Hiragino Sans GB,Microsoft Yahei,微软雅黑, Arial, sans-serif">其他用户需求的</p>
...
<tr>
	...
	<c:forEach items="${grid.datas}" var="data" varStatus="index" >
		...
		<woo:permission operationType="TRADE_DELETE" roleType="ROLE_TRADE">
									<a href="javascript:void(0);" data-id="${data.trade }"  class="btnEdit" data-url="trade/sellernoensure">
									[不租]
									</a>
		                        </woo:permission>
		</th>
