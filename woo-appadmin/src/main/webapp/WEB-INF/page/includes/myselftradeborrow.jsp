...
<p style="font-family: Helvetica,Hiragino Sans GB,Microsoft Yahei,微软雅黑, Arial, sans-serif">你要租借别人的物品</p>
...
<tr>
	...
	<c:forEach items="${grid.datas}" var="data" varStatus="index" >
		...
		<woo:permission operationType="TRADE_DELETE" roleType="ROLE_TRADE">
									<a href="javascript:void(0);" data-id="${data.trade }"  class="btnEdit" data-url="trade/cancelborrow">
									[取消租借]
									</a>
		</woo:permission>
		</th>
