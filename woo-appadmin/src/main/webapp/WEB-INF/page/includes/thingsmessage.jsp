       ...
       <div class="form-gourp">
        ...
        <div class="form-gourp">
          <label>图片</label>
              ...
              <c:if test="${picname != '' }">
              <li data-src="<woo:url value="/static/thingspicture/${picname }"/>" > 
        	  <a href="#">
              <img src="<woo:url value="/static/thingspicture/${picname }"/>" alt="" id="lis"  class="img-rounded" />
              </a>
              </li>
              </c:if>
              <c:if test="${onepicture != '' }">
              <li data-src="<woo:url value="/static/thingspicture/${onepicture }"/>"   > 
        	  <a href="#">
              <img src="<woo:url value="/static/thingspicture/${onepicture }"/>" alt="" id="lis"   class="img-rounded" />
              </a>
              </li>
              </c:if>
              <c:if test="${twopicture != '' }">
              <li data-src="<woo:url value="/static/thingspicture/${twopicture }"/>" >  
        	  <a href="#">
              <img src="<woo:url value="/static/thingspicture/${twopicture }"/>" alt="" id="lis"  class="img-rounded" />
              </a> 
              </li>
              </c:if>
    </ul>
