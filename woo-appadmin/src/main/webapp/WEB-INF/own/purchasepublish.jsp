		 ...
		 <div class="about-info">
			 ...
			 <div class="top-grid-section" style="text-align:center;">
					 <div class="col-md-3 top-grids">
						 <a href="/purchase/${data.companyid}"><i class="glyphicon glyphicon-gift"></i><h4>产品详细信息</h4></a>
					 </div>		
					 <div class="col-md-3 top-grids">
					 	  <a href="/purchase/update/${data.companyid}"><i class="glyphicon glyphicon-gift"></i><h4>修改产品信息</h4></a>
					 </div>	
					 <div class="clearfix"></div>
			  </div>
	     </div>
