	 ...
	 <div class="container">
		 ...
		 <div class="about-info">
			 <div class="col-md-6 about-left">
                 ...
                 <h4 style="text-align:right;color:#EE6363;">产品联系人:${data.contact }</h4>
                 <h4 style="text-align:right;color:#EE6363;">产品联系人电话:${data.contactphone }</h4>
			 </div>
			 ...
			 <div class="top-grid-section" style="text-align:center;">
					 <div class="col-md-3 top-grids">
						 <a href="/commodity/${data.companyid}"><i class="glyphicon glyphicon-gift"></i><h4>产品详细信息</h4></a>
					 </div>		
					 <div class="col-md-3 top-grids">
						 <a href="/commodity/update/${data.companyid}"><i class="glyphicon glyphicon-gift"></i><h4>修改产品信息</h4></a>
					 </div>	
					 <div class="clearfix"></div>
			  </div>
	     </div>
